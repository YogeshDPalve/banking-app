...
<html>
  ...
  <body style="margin: 0; padding: 0; background-color: #f4f4f4;">
          ...
          <table cellpadding="0" cellspacing="0" border="0" style="max-width: 600px; width: 100%; background-color: #ffffff; border-radius: 8px; box-shadow: 0 0 10px rgba(0,0,0,0.05); font-family: Arial, sans-serif; margin: auto;">
            ...
            <tr>
              <td align="center" style="padding: 20px 0;">
                <img src="https://png.pngtree.com/png-vector/20240705/ourmid/pngtree-illustration-of-bank-vector-png-image_12847677.png" alt="Company Logo" width="120" style="display: block;">
              </td>
            </tr>
    ...
    console.log("Error to send email to employee : ", error);
  }
};
